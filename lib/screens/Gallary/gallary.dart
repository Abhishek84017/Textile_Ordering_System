...
class _GalleryPageState extends State<GalleryPage> {
  ...
  {
    setState((){
      searchGalleryData = GalleryData.where((element) => element.code.toString().contains(code)).toList();
    });
  }
    ...
    return Scaffold(
      ...
      body: GalleryData.isNotEmpty ? Column(
        children: [
          ...
          Expanded(
            child: _controller.text.isEmpty ? GridView.builder(
                ...
                }) : searchGalleryData.isNotEmpty ?  GridView.builder(
